...
public:
	...
	///* if this is true, laser NIS will be calculated and printed for every sample.
	bool calc_laser_nis_;

	///* if this is true, radar NIS will be calculated and printed for every sample.
	bool calc_radar_nis_;
	...
	///* The number of laser measurements
	unsigned long laser_n_samples_;
	 ...
	 */
	void
	ProcessMeasurement(MeasurementPackage meas_package);
